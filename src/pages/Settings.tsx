...
import { 
  User, Bell, Shield, Palette, Sun, Moon, Monitor, Key, Webhook
} from 'lucide-react';
...
export default function Settings() {
  ...
  return (
    ...
    >
      {/* Tabs for admins to access API Keys & Integrations */}
...
function SettingsContent({ theme, handleThemeChange, isSuperAdmin }: SettingsContentProps) {
  return (
